...
class AwesomeNotificationsHelper {
  // AcceptOrRejectCallUseCase acceptOrRejectCallUseCase;
  // prevent making instance
  AwesomeNotificationsHelper(
      // required this.acceptOrRejectCallUseCase,
      );
  ...
  static showNotification(
    ...
    //   //get all chats
    //   var data = json.decode(payload!['chat']!);
    //   if (data['last_message']['sender']['id'] ==
    //       Get.find<ChatMessagesController>().remoteUserId) {
    //     return;
    //   }
    // }
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if (payload != null) {
      if (receivedAction.buttonKeyPressed == "") {
        ...
        //   Get.toNamed(
        //     Routes.chat,
        //     arguments: MessageModel.fromMap(chat),
        //   );
        // }
      }
    }
