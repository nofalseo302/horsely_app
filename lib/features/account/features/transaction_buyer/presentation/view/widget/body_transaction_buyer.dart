...
import 'package:horsely_app/features/account/features/transaction_buyer/presentation/view/widget/transaction_buyer_tab_bar.dart';

class BodyTransactionBuyer extends GetView<TransactionsController> {
                ...
                child: Column(
                  children: [
                    ...
                    TitleAndWidget(
                      ...
                      childWidget: Obx(
                        () => CustomAnimatedDropdown(
                          ...
                          onChanged: (value) =>
                              controller.coinType.value = value.toString(),
                    ...
                    Obx(
                      () => TitleAndWidget(
                        ...
                        childWidget: CustomAnimatedDropdown(
                          onChanged: (p0) =>
                              controller.currency.value = p0.toString(),
                    ...
                    Obx(() => TitleAndWidget(
                          ...
                          childWidget: CustomAnimatedDropdown(
                            onChanged: (p0) =>
                                controller.paymentType.value = p0.toString(),
