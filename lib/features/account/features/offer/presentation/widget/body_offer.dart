  ...
  Widget build(BuildContext context) {
    return Obx(
      () => controller.isLoading.value
          ? const CustomLoader()
          : controller.offersData.value?.data == null
              ? RetryWidget(onRetry: () {
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                "${AppStrings.totaloffer.tr}(${controller.offersData.value?.data?.counts ?? 0})",
                              ...
                              Expanded(
                                child: ListView.builder(
                                  itemCount: controller
                                          .offersData.value?.data?.counts ??
                                      0,
                                  itemBuilder: (context, index) => Padding(
                                    padding: const EdgeInsets.symmetric(
                                        vertical: 8.0),
                                    child: IteamOffer(
                                        offerModel: controller.offersData.value!
                                            .data!.offers!.data![index]),
                                  ),
                                ),
                              )
                            ],
